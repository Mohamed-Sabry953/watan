...
class AlternativeCard extends StatelessWidget {
  const AlternativeCard({required this.index,  super.key});
  final int index;
          ...
          child: Column(
            children: [
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(50),
                child: Image.network(
                  BoycottCubit.get(context).boycottRepoImp.allAlternitiveModel?.data?[index].image??"",
                  height: widgetHeight(context: context, height: 100),
              ...
              SizedBox(height: widgetHeight(context: context, height: 25)),
              Text(
                BoycottCubit.get(context).boycottRepoImp.allAlternitiveModel?.data?[index].name??"",
              ...
              Text(
                BoycottCubit.get(context).boycottRepoImp.allAlternitiveModel?.data?[index].productType??"",
                style: const TextStyle(
                  color: Color(0XFF000000),
                  fontSize: 10,
