class BoycottModel {
  ...
  BoycottModel.fromJson(dynamic json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != "هذا المنتج ليس في المقاطعه" ? Data.fromJson(json['data']) : null;
    dataMsg= json['data'] != "هذا المنتج ليس في المقاطعه" ?null:json['data'];
  }
  bool? success;
  String? message;
  Data? data;
