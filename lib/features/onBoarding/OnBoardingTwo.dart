          ...
          child: Column(
            ...
            children: [
              ...
              ClipRRect(
                  ...
                  child: SvgPicture.asset(Images.onBoardingImage, height: 250,width: 400,fit: BoxFit.fill,)), // استبدل 'assets/phone.png' بمسار الصورة
              ...
              InkWell(
                onTap: (){
                  Navigator.pushNamedAndRemoveUntil(context, AppRoutesName.onboardingThree, (route) => false,);
                },
                child: Container(
